...
document.body.insertAdjacentHTML("afterbegin", `<img id="pointerarrow" src="../Arrow-right-512.png" style="height: 70px; width: 70px; position: absolute; top: 135px;transition-duration:500ms;">`)
var pointerarrow = document.getElementById("pointerarrow")
pointerarrow.style.display = "none";

log.insertAdjacentHTML("afterbegin", '<p style="font-size:x-large; margin-top:-5px;  color:black;font-family:Segoe UI;">' + "Steps..." + '</p>')
...
pausebtn.addEventListener("click", function () {
  ...
  if (document.getElementById("animationplay") == null) {
    ...
    Log(`<span style="color:black;font-size:130%;">You can pause animation only while they are running.</span>`)
...
skipbtn.addEventListener("click", function () {
  ...
  if (stats == 1) {
    ...
    Log(`<span style="color:black;font-size:130%;">Cant Skip a paused animation.</span>`)
  ...
  if (document.getElementById("animationplay")) {
    ...
    Log(`<span style="color:black;font-size:170%;">Skipping animation.</span>`)
    skipper = 1;
    ...
    Log(`<span style="color:black;font-size:130%;">You can skip animation only while they are running.</span>`)
...
function Output(data) {
  ...
  $("#log1").append('<p style="font-size:large; margin-top:-5px;  color:black;font-family:Roboto;">' + data + '</p>')
...
codehere.addEventListener("keypress", async function (e) {
  ...
  if (e.key == "Enter") {
    ...
    try {
      document.getElementById("log1").insertAdjacentHTML("beforeend", '<p style="font-size:large;  color:black;font-family:Segoe UI;">' + command.toUpperCase() + '</p>')
